...
public class RecipientCreateBankAccountRequest {
  /**
 ...
 public enum HolderTypeEnum {
  ...
  public RecipientCreateBankAccountRequest() {
  }

  public RecipientCreateBankAccountRequest type(TypeEnum type) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest holderName(String holderName) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest holderTaxId(String holderTaxId) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest holderType(HolderTypeEnum holderType) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest branchNumber(String branchNumber) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest accountNumber(String accountNumber) {
  ...
  **/
  ...
  public RecipientCreateBankAccountRequest bankId(String bankId) {
  ...
  **/
   ...
   * @return the RecipientCreateBankAccountRequest instance itself
   */
  public RecipientCreateBankAccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientCreateBankAccountRequest recipientCreateBankAccountRequest = (RecipientCreateBankAccountRequest) o;
    return Objects.equals(this.type, recipientCreateBankAccountRequest.type) &&
        Objects.equals(this.holderName, recipientCreateBankAccountRequest.holderName) &&
        Objects.equals(this.holderTaxId, recipientCreateBankAccountRequest.holderTaxId) &&
        Objects.equals(this.holderType, recipientCreateBankAccountRequest.holderType) &&
        Objects.equals(this.branchNumber, recipientCreateBankAccountRequest.branchNumber) &&
        Objects.equals(this.accountNumber, recipientCreateBankAccountRequest.accountNumber) &&
        Objects.equals(this.bankId, recipientCreateBankAccountRequest.bankId)&&
        Objects.equals(this.additionalProperties, recipientCreateBankAccountRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientCreateBankAccountRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientCreateBankAccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientCreateBankAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientCreateBankAccountRequest is not found in the empty JSON string", RecipientCreateBankAccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecipientCreateBankAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientCreateBankAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientCreateBankAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientCreateBankAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientCreateBankAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientCreateBankAccountRequest>() {
           @Override
           public void write(JsonWriter out, RecipientCreateBankAccountRequest value) throws IOException {
           ...
           @Override
           public RecipientCreateBankAccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientCreateBankAccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientCreateBankAccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientCreateBankAccountRequest
  * @throws IOException if the JSON string is invalid with respect to RecipientCreateBankAccountRequest
  */
  public static RecipientCreateBankAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientCreateBankAccountRequest.class);
  }

 /**
  * Convert an instance of RecipientCreateBankAccountRequest to an JSON string
  *
  * @return JSON string
  */
